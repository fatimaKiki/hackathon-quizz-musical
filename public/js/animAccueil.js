...
lib.ssMetadata = [
		{name:"animAccueil_atlas_1", frames: [[554,141,209,139],[0,0,832,139],[0,141,552,139]]}
];
...
(lib.les3 = function() {
	this.initialize(ss["animAccueil_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},29).to({state:[{t:this.instance_3}]},30).to({state:[{t:this.instance_4}]},30).to({state:[{t:this.instance_5}]},43).to({state:[{t:this.instance_6}]},31).to({state:[{t:this.instance_4}]},46).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({_off:true,x:526.75},30).wait(151));
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(132).to({_off:false},0).to({_off:true,x:-407.25,y:739.2},31).wait(47));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(59).to({_off:false},0).to({_off:true,y:389.6},30).wait(121));
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(59).to({_off:false},30).wait(43).to({startPosition:0},0).to({x:-462.3,y:363.95},31).wait(46).to({x:149.6,y:389.6},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_9}]}).to({state:[{t:this.instance_10}]},29).to({state:[{t:this.instance_11}]},60).to({state:[{t:this.instance_12}]},43).to({state:[{t:this.instance_13}]},31).to({state:[{t:this.instance_11}]},46).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({_off:true,x:459.85},29).wait(181));
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(132).to({_off:false},0).to({_off:true,x:-239.1,y:-173.55},31).wait(47));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"public/images/microGris.png?1639103677136", id:"microGris"},
		{src:"public/images/animAccueil_atlas_1.png?1639103677094", id:"animAccueil_atlas_1"}
	],
	preloads: []
};
